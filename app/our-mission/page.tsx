...
// The standalone /our-mission page has been removed as requested.
// Its full design is integrated directly into the homepage (#vision section).
// Any direct visits automatically redirect smoothly to /#vision.
export default function MissionPage() {
    redirect('/#vision');
}

// ══════════════════════════════════════════════════════════════════════════
// ORIGINAL OUR MISSION PAGE CODE (COMMENTED OUT AS REQUESTED)
// ══════════════════════════════════════════════════════════════════════════
//
// 'use client';
//
...
//
// export function LegacyMissionPage() {
//     return (
...
//                 {/* Header */}
//                 <header className="flex items-center justify-between mb-8 sm:mb-20 animate-fade-in-down">
...
//                     </div>
//
//                     <h1 className="text-4xl sm:text-6xl md:text-[100px] lg:text-[120px] font-black leading-none mb-4 sm:mb-8 tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-white/80 to-white/20 drop-shadow-2xl select-none">
...
//                         <h2 className="relative text-xl sm:text-3xl md:text-5xl lg:text-6xl font-serif font-medium italic leading-tight text-white drop-shadow-xl px-2 sm:px-4 py-4 sm:py-8">
//                             <span className="text-amber-500 font-serif text-4xl sm:text-6xl md:text-8xl absolute -top-4 left-0 md:-left-8 opacity-40">&quot;</span>
...
//                             <span className="text-amber-500 font-serif text-4xl sm:text-6xl md:text-8xl absolute -bottom-8 right-0 md:-right-8 opacity-40">&quot;</span>
//                         </h2>
//                     </div>
//
//                     <div className="w-24 h-1 bg-gradient-to-r from-transparent via-amber-500 to-transparent mx-auto mt-6 sm:mt-12 rounded-full opacity-50"></div>
//                 </div>
//
//                 {/* Core Pillars */}
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8 px-0 sm:px-4">
//                     {[
//                         {
//                             icon: Globe,
//                             title: "Global Reach",
...
//                             <div className="h-full bg-[#0A0A0A] border border-white/5 rounded-2xl sm:rounded-3xl p-5 sm:p-8 relative overflow-hidden group hover:border-white/20 transition-all duration-500">
...
//                                     <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-500 shadow-[0_0_30px_rgba(0,0,0,0.5)] ${item.color}`}>
//                                         <item.icon className="w-6 h-6 sm:w-8 sm:h-8" />
//                                     </div>
//                                     <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-4 group-hover:tracking-wider transition-all duration-300">{item.title}</h3>
...
//                     <Link href="/contact" className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3.5 sm:py-4 bg-white text-black rounded-full font-bold hover:bg-amber-400 transition-colors hover:scale-105 active:scale-95 duration-300 shadow-[0_0_40px_rgba(255,255,255,0.1)] text-xs sm:text-sm">
