            ...
            <div className="max-w-4xl mx-auto space-y-10 sm:space-y-16 pt-8 sm:pt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                    {leaders.map((leader, i) => (
                        <div key={i} className="rounded-2xl sm:rounded-3xl bg-neutral-900 border border-white/15 overflow-hidden p-4 sm:p-6 space-y-4 shadow-2xl">
                            <div className="relative h-52 sm:h-64 w-full rounded-xl sm:rounded-2xl overflow-hidden">
                            ...
                            <div>
                                ...
                                <h3 className="text-xl sm:text-2xl font-bold text-white mt-1">{leader.name}</h3>
