...
export default function AddSongPage() {
    ...
    const [aiArtist, setAiArtist] = useState(''); // New: Artist Context
    ...
    const handleAiGenerate = async () => {
        ...
        try {
            const res = await fetch('/api/generate-song', {
                ...
                body: JSON.stringify({
                    songName: aiPrompt,
                    artist: aiArtist // Send artist context
                })
            });
            ...
            setFormData(prev => ({
                ...
                lyrics: data.lyrics || "",
                chords: data.chords || "",
                hindi_lyrics: data.hindi_lyrics || "", // Fix: Capture Hindi Lyrics
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log("Submitting Song as User:", userId);
                    ...
                    <div className="mb-8">
                        ...
                        {activeTab === 'ai' && (
                            <div className="bg-gradient-to-r from-purple-500/10 to-transparent border border-purple-500/20 rounded-3xl p-6 animate-fade-in-down mb-8">
                                ...
                                <p className="text-white/40 text-sm mb-4">
                                    Enter the song title AND artist for better accuracy.
                                </p>
                                ...
                                <p className="text-xs text-white/20 mt-2">* Requires OpenRouter/OpenAI API Key.</p>
                            </div>
                        )}
                    </div>
