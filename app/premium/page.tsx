        ...
        <div className="min-h-screen bg-[#02000F] text-white px-4 sm:px-6 py-6 pb-32 overflow-hidden relative">
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                <div className="text-center mb-8 sm:mb-16">
                    <h1 className="text-2xl sm:text-4xl md:text-6xl font-black mb-2 sm:mb-4">Upgrade to <span className="text-amber-500">Pro</span></h1>
                    <p className="text-sm sm:text-base md:text-xl text-white/50">Unlock the full worship experience.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
                    {plans.map((plan, i) => (
                        <div key={i} className={`relative p-5 sm:p-8 rounded-2xl sm:rounded-[2rem] border ${plan.active ? 'border-white/20 bg-white/5' : 'border-amber-500/50 bg-gradient-to-br from-amber-500/10 to-transparent'}`}>
