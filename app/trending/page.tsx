    ...
    return (
        <div className="min-h-screen bg-[#02000F] text-white p-6 pb-32">
            ...
            <div className="flex items-center gap-4 mb-12 pt-4">
                ...
                <div>
                    <h1 className="text-4xl md:text-5xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-orange-500 to-amber-500 drop-shadow-lg">
                        Trending Now
                    </h1>
                    <p className="text-white/60 font-medium tracking-wide">Top 20 worship songs moving hearts globally</p>
                </div>
            </div>
                    ...
                    <TiltCard key={song.id} className="h-full min-h-[300px]" max={15} scale={1.05}>
                        <div className="relative h-full group">
                            ...
                            >
                                ...
                                <div className="absolute top-[-20px] right-[-20px] text-[150px] font-black text-white/5 leading-none z-0 pointer-events-none select-none italic group-hover:text-white/10 transition-colors">
                                    {i + 1}
                                </div>
