        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
            ...
            <div className="text-center pointer-events-auto flex flex-col items-center">
                <div className="mb-6 animate-fade-in-down">
                    <Logo className="w-32 h-32 text-[var(--brand)] drop-shadow-[0_0_15px_rgba(255,109,0,0.5)]" />
                </div>
                {/* <h1 className="text-6xl font-bold tracking-tighter mb-2">COJ</h1> */}
                <p className="tracking-[0.5em] uppercase opacity-70 mb-8 text-xs font-medium">Call of Jesus Ministries</p>
